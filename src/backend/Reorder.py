...
from src.database.HelperFunctions import sku_on_order, total_demand, mean_weekly, mean_daily, stock, sd_weekly
...
def predictDemand(SKU):
    ...
    if generate_confidence_interval:
        ...
        plt.fill_between(predicted_demand['Date'], (wls_predictions - epsilon), (wls_predictions + epsilon), color='b',
                         alpha=0.2)
