...
# ADD TIME TAKEN TO RECEIVE TO DATABASE AND FUNCITON TO TO SEND THE MAXIMUM TIME TAKEN, AVERAGE TIME TAKEN, STANDARD DEVIATION //// SAFETY STOCK PARAMETERS

# SAVE ALL THE GRAPHS IN FORMAT JPG
